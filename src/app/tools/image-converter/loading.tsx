...
/** Mirrors the converter layout: header, workbench card, article, related tools. */
export default function ImageConverterLoading() {
    return (
        <div className="flex flex-col gap-10 lg:gap-12" aria-hidden="true">
            ...
            <div className="bg-card ring-border/70 flex flex-col gap-5 rounded-xl p-5 ring-1 ring-inset sm:p-6">
                ...
                {/* Five controls: target, quality, background, longest edge, icon sizes. */}
