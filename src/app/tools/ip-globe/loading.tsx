...
/** Mirrors the IP & Route Globe page: header, form card, article, related tools. */
export default function IpGlobeLoading() {
    return (
        <div className="flex flex-col gap-10 lg:gap-12" aria-hidden="true">
            ...
            <div className="bg-card ring-border/70 flex flex-col gap-5 rounded-xl p-5 ring-1 ring-inset sm:p-6">
                ...
                {/* Mode and resolver, side by side above the box. */}
