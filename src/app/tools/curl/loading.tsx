...
/** Mirrors the cURL page: header, workbench card, article, related tools. */
export default function CurlLoading() {
    return (
        <div className="flex flex-col gap-10 lg:gap-12" aria-hidden="true">
            ...
            <div className="bg-card ring-border/70 flex flex-col gap-5 rounded-xl p-5 ring-1 ring-inset sm:p-6">
                ...
                {/* Direction tabs, sized to their two choices. */}
                <div className="flex flex-col gap-2">
                    <Skeleton className="h-3.5 w-16" />
                    <Skeleton className="h-8 w-full max-w-80 rounded-lg" />
                </div>
