...
/** Mirrors the Text Sorter layout: header, workbench card, then the article. */
        ...
        <div className="flex flex-col gap-10 lg:gap-12" aria-hidden="true">
            ...
            <div className="bg-card ring-border/70 flex flex-col gap-5 rounded-xl p-5 ring-1 ring-inset sm:p-6">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    {/* Five order chips, two across at 390 px and five on a wide
                        screen — the same grid the picker renders. */}
                ...
                {/* Five selects and the starting-number stepper. */}
