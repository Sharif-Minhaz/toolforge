...
/** Mirrors the Equation to LaTeX layout: header, workbench card, then the article. */
export default function EquationLoading() {
    return (
        <div className="flex flex-col gap-10 lg:gap-12" aria-hidden="true">
            ...
            <div className="bg-card ring-border/70 flex flex-col gap-5 rounded-xl p-5 ring-1 ring-inset sm:p-6">
                ...
                {/* The Text / Image switch, then whichever panel it selects.
                    Text is the mode the page opens on. */}
                <div className="flex flex-col gap-2">
                ...
                {/* Source and preview sit side by side from the large breakpoint,
                    which is exactly what the workbench renders. */}
