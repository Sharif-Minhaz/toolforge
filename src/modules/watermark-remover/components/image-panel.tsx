...
/**
 * The picture half of the tool: brush over a watermark and a model repaints the
 * square it sits in.
 *
 * Lifted out of the workbench whole when the video half arrived, and otherwise
 * unchanged — the card, its heading and the tab strip now live above it.
 */
...
export function ImagePanel({ siteKey, urlImportEnabled }: ImagePanelProps) {
                    ...
                    <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:items-center">
                        ...
                        <div className="flex shrink-0 flex-wrap items-center gap-2">
                            ...
                            <Button
                                ...
                                className="h-8 px-3 text-[0.8125rem]"
                            >
                                <IconEraser className="size-4" stroke={1.8} aria-hidden="true" />
                                {t("clearMask")}
                            </Button>
                        </div>
                    </div>
