...
/**
 * The whole of `/json` that reacts: the server list, the two ways to gain one,
 * and the single showing of a recovery key.
 *
...
export function ServerLauncher({ overview, turnstileSiteKey }: ServerLauncherProps) {
    const t = useTranslations("jsonServer.launcher");
    ...
    const [servers, setServers] = useState<readonly JsonServerSummary[]>(overview.servers);
