...
import { IconAbc, IconPercentage, type IconProps } from "@tabler/icons-react";
import { motion } from "motion/react";
import { useTranslations } from "next-intl";
import type { ComponentType } from "react";

import { cn } from "@/lib/utils";
import { URL_MODES, type UrlMode } from "../types";

const MODE_ICONS: Record<UrlMode, ComponentType<IconProps>> = {
    encode: IconPercentage,
    decode: IconAbc,
};
