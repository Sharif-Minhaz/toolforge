...
import { IconArrowsExchange, IconList, IconTargetArrow, type IconProps } from "@tabler/icons-react";
import { motion } from "motion/react";
import { useTranslations } from "next-intl";
import type { ComponentType } from "react";

import { cn } from "@/lib/utils";
import { REGEX_MODES, type RegexMode } from "../types";

const MODE_ICONS: Record<RegexMode, ComponentType<IconProps>> = {
    match: IconTargetArrow,
    substitute: IconArrowsExchange,
    list: IconList,
};

type ModeSelectorProps = {
    value: RegexMode;
    onChange: (mode: RegexMode) => void;
    labelId: string;
};
