...
import { IconHtml, IconMarkdown, type IconProps } from "@tabler/icons-react";
import { motion } from "motion/react";
import { useTranslations } from "next-intl";
import type { ComponentType } from "react";

import { cn } from "@/lib/utils";
import { HTML_MARKDOWN_MODES, type HtmlMarkdownMode } from "../types";

/** The icon names the format being *read*, which is what the reader is holding. */
const MODE_ICONS: Record<HtmlMarkdownMode, ComponentType<IconProps>> = {
    htmlToMarkdown: IconHtml,
    markdownToHtml: IconMarkdown,
};

type ModeSelectorProps = {
    value: HtmlMarkdownMode;
    onChange: (mode: HtmlMarkdownMode) => void;
    labelId: string;
};
            ...
            {HTML_MARKDOWN_MODES.map((mode) => {
                ...
                return (
                    ...
                    >
                        {selected && (
                            <motion.span
                                layoutId="html-markdown-mode-indicator"
