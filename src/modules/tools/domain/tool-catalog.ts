...
const TOOLS: readonly Tool[] = [
    ...
    },
    {
        ...
        category: "text",
        status: "available",
        // Hybrid rather than browser: typing an equation never leaves the tab,
        // but reading one out of a picture sends it to a recognition model.
        runsOn: "hybrid",
        accent: "amber",
        icon: "math",
        addedOn: "2026-08-14",
