 ...
 *
 * Its own cookie name rather than sharing either other studio's, because a
 * visitor holding five JSON servers must not thereby be at capacity for GraphQL
 * ones — one shared list would make "you can hold five" mean something different
