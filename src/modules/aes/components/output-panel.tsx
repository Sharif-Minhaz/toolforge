...
type OutputPanelProps = {
    ...
    /** A second line for what the mode does or does not promise. */
     ...
     * consequence. A decrypted file is bytes and nothing else, so there the
     * button is the only way to finish the round trip.
     */
