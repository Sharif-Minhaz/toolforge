...
The **Image Compressor** is browser-only with no exception at all. Its four encoders — MozJPEG,
...
location never reach a server. It needs no environment variable and no database row.
