...
| Tool                     | Route           | Status  |
| ------------------------ | --------------- | ------- |
| UUID Generator           | `/tools/uuid`   | Shipped |
| Base64 Encoder / Decoder | `/tools/base64` | Shipped |

Planned and already visible in the catalogue: JSON Formatter, JWT Decoder, Hash Generator,
Password Generator, Regex Tester, Timestamp Converter, URL Encoder, Color Converter, Cron Parser,
QR Generator, Diff Checker, Slug Generator, Lorem Ipsum.
